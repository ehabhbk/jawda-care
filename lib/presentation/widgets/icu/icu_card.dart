          ...
          children: [
            Container(
              ...
              child: Stack(
                children: [
                  Center(
                    child: Icon(Icons.local_hospital, size: 48, color: AppColors.primary.withValues(alpha: 0.3)),
                  ),
                  Positioned(
                    top: 12,
                    right: 12,
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: icu.isAvailable ? AppColors.success : AppColors.error,
                  ...
                  Row(
                    children: [
                      ...
                      if (icu.rating != null) ...[
                        ...
                        const SizedBox(width: 4),
                        Text(icu.rating!.toStringAsFixed(1), style: const TextStyle(color: AppColors.textSecondary)),
                      ],
                    ],
                  ),
                ],
